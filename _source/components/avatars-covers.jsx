/* global React, Icon, Wordmark, Frame, COLORS, DotGrid, BrandStamp, Ico, AbstractCompute */
...
function AvatarArtboard({ variant = 'indigo' }) {
      ...
      <div style={{ position: 'relative', height: '100%', padding: '60px 90px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', zIndex: 2 }}>
        <div style={{ maxWidth: 820 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 12px', borderRadius: 999, background: 'rgba(62,138,94,0.18)', border: '1px solid rgba(62,138,94,0.4)', color: '#7DC79A', fontSize: 12, fontWeight: 600, letterSpacing: '0.04em', marginBottom: 20 }}>
            <span style={{ width: 6, height: 6, borderRadius: 999, background: '#7DC79A' }} /> Inference runs in a Trusted Execution Environment
          </div>
          ...
          <div style={{ fontSize: 18, color: COLORS.ink200, marginTop: 18, maxWidth: 560 }}>
            Visual chatflows, RAG knowledge bases, and one-click deploys to Discord, Slack, Telegram, WhatsApp, web.
          </div>
        </div>
    ...
    <Frame lane="lane-light" width={1584} height={396} style={{ background: COLORS.ink0 }}>
      ...
      <div style={{ position: 'relative', height: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', alignItems: 'center', zIndex: 2 }}>
        <div style={{ padding: '0 64px' }}>
          <div className="eyebrow" style={{ fontSize: 12, color: COLORS.signal700 }}>Privacy-first AI automation</div>
          ...
          <div style={{ fontSize: 16, color: COLORS.ink500, marginTop: 14, maxWidth: 460 }}>
            No-code chatflows. Encrypted inference. Cross-platform deployment in a single workspace.
          </div>
        </div>
        <div style={{ height: '100%', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ position: 'absolute', bottom: 28, right: 64, color: '#fff', fontFamily: 'Inter Tight', fontWeight: 800, fontSize: 22, letterSpacing: '0.08em' }}>PRIVEXBOT</div>
        </div>
      </div>
    </Frame>
  );
      ...
      <div style={{ position: 'relative', height: '100%', padding: '56px 72px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', zIndex: 2 }}>
        <div>
          ...
          <div style={{ fontSize: 18, color: COLORS.ink200, marginTop: 12, maxWidth: 540 }}>
            Live coding sessions, RAG deep dives, and chaotic deploys. Pop in.
          </div>
        </div>
...
Object.assign(window, { AvatarGallery, AvatarArtboard, XHeader, LinkedInCover, YouTubeBanner, FacebookCover, TwitchBanner });
